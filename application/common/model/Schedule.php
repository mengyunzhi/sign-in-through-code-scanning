...
class Schedule extends Model {
    ...
    {
        return isset($this->data['teacher']) ? $this->data['teacher'] : Teacher::get($this->getTeacherId());
    }
    ...
    {
        return isset($this->data['term']) ? $this->data['term'] : Term::get($this->getTeacherId());
    }
    ...
    {
        return isset($this->data['course']) ? $this->data['course'] : Course::get($this->getTeacherId());
    }
