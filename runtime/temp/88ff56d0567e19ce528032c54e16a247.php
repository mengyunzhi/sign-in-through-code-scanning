<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:106:"C:\Users\DELL\Desktop\yunzhi\lampp\htdocs\thinkphp\public/../application/admin\view\admin_student\add.html";i:1650099776;s:113:"C:\Users\DELL\Desktop\yunzhi\lampp\htdocs\thinkphp\public/../application/admin\view\.\..\..\index\view\index.html";i:1650095877;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<form class="" action="<?php echo url('save'); ?>" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="radio" name="sex" value="0" id="sex0" checked/><label for="sex0" >男</label>
            <input type="radio" name="sex" value="1" id="sex1" /><label for="sex1">女</label>
        </div>
    </div>
    <div class="form-group row">
        <label for="klass_id" class="col-sm-2 col-form-label">班级</label>
        <div class="col-sm-4">
            <select class="selectpicker form-control col-sm-12" name="klass_id" id="klass">
    ...
    <div class="form-group row">
        <label for="sno" class="col-sm-2 col-form-label">学号</label>
        <div class="col-sm-4">
