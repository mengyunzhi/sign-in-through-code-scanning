<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:108:"C:\Users\DELL\Desktop\yunzhi\lampp\htdocs\thinkphp\public/../application/admin\view\admin_teacher\index.html";i:1650092301;s:113:"C:\Users\DELL\Desktop\yunzhi\lampp\htdocs\thinkphp\public/../application/admin\view\.\..\..\index\view\index.html";i:1650095877;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<div class="row">
    <div class="col-md-3">
        <a href="<?php echo url('add'); ?>" class="btn btn-primary"><i class="glyphicon"></i>&nbsp;添加教师</a>
    </div>
    <div class="col-md-10">
        <form class="form-inline">
            <div class="form-group">
                <input name="name" type="text" class="form-control" placeholder="姓名" style="margin-top: 20px" value="<?php echo $name; ?>">
                <input name="number" type="text" class="form-control" placeholder="手机号" style="margin-top: 20px" value="<?php echo $number; ?>">
            </div>
            <div class="form-group">
...
<table class="table table-hover table-bordered">
    ...
    <tr>
        <td><?php echo $key; ?></td>
        <td><?php echo $_Teacher->getName(); ?></td>
        <td><?php echo $_Teacher->getSex(); ?></td>
        <td><?php echo $_Teacher->getNumber(); ?></td>
        <td>
            <a href="<?php echo url('edit?id='. $_Teacher->getId()); ?>" class="btn btn-primary">编辑</a> &nbsp;&nbsp;
            <a href="<?php echo url('delete?id='. $_Teacher->getId()); ?>" class="btn btn-danger">删除</a>
        </td>
    </tr>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</table>
